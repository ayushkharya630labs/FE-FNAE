        ...
        <>
            ...
            <section className="py-16 bg-[#f4f4f4]">
                <div className="container-main">
                    ...
                    <div className="flex mb-20 items-stretch">
                        ...
                        <div className="basis-1/2 p-8 bg-[#47A5AE] flex flex-col justify-center">
                            ...
                            <p className="text-sm text-white max-w-xl leading-relaxed">
                                Every system can be customized, upon request, for compliance with applicable
                                rules, regulations and project specific requirements as well as standard such
                                as CE, FM, UL, ASME, DIN, DNV, BV, NMD, IMO, NFPA, Norsok. Full documentation
                                for any tailor-made products are available and include all necessary
                                certifications, third party verifications such as DNV/GL, BV, ABS, etc.,
                                and full scale test reports, if required.
                            </p>
                        </div>
                        ...
                        <div className="basis-1/2">
                            <img
                                src="/images/systems/system-1.jpg"
                    ...
                    {/* Foam Supply */}
                    <div className="mb-16">
                        <h2 className="section-title mb-3">FOAM SUPPLY</h2>
                        ...
                        <ul className="list-disc pl-5 text-[14px] text-[#6C6D70]">
                            <li>Turbine foam proportioner</li>
                            <li>Balanced pressure foam proportioner</li>
                            <li>Foam inductor</li>
                            <li>Constant flow orifice</li>
                        </ul>
                    </div>
